...
<div class="content-wrapper">
  <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-4">
            <h1>Haed Teacher's list (Total:{{ $getRecord->total() }})</h1>
          </div>
          <div class="col-sm-4">
            @include('_message')
          </div>
          <div class="col-sm-4" style="text-align: right;" >
            <a href="{{url('admin/Headteacher/add')}}" class="btn btn-primary">Add new Teacher</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  </section>
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="form-group col-md-3" style="margin-top:32px">
                        ...
                        <a href="{{url('admin/Headteacher/list')}}" class="btn btn-success">Clear</a>
                      </div>
                    </div>
                  </div>
              </form>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="min-width:140px;">
                      <a href="{{url('admin/Headteacher/edit/'.$value->id)}}" class="btn btn-success mr-2 btn-sm">Edit</a>
                      <a href="{{url('admin/Headteacher/delete/'.$value->id)}}" class="btn btn-danger btn-sm">Delete</a> 
                    </td>
                  </tr>
                  @endforeach
                </tbody>
