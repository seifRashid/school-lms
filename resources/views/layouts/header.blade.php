  ...
  <!-- /.navbar -->
   ...
   <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <span class="brand-text font-weight-light"><b>INTERGRATED</b> SMS</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('admin/Headteacher/list')}}" class="nav-link @if(Request::segment(2)=='Headteacher') active @endif">
              <i class="nav-icon far fa-user"></i>
              <p>
                Head Teacher
              </p>
          ...
          <li class="nav-item">
            <a href="{{url('admin/school/list')}}" class="nav-link @if(Request::segment(2)=='school') active @endif">
              <i class="nav-icon far fa-user"></i>
              <p>
                Schools
              </p>
          ...
          @elseif(Auth::user()->user_type == 4)
              <li class="nav-item">
                <a href="{{url('official/dashboard')}}" class="nav-link @if(Request::segment(2)=='dashboard') active @endif">
                  <i class="nav-icon fas fa-tachometer-alt"></i>
                  <p>
                    Dashboard
                    <span class="badge badge-info right">2</span>
          ...
          @elseif(Auth::user()->user_type == 5) 
              <li class="nav-item">
                <a href="{{url('school/dashboard')}}" class="nav-link @if(Request::segment(2)=='dashboard') active @endif">
                  <i class="nav-icon fas fa-tachometer-alt"></i>
                  <p>
                    Dashboard
                    <span class="badge badge-info right">2</span>
              ...
              <li class="nav-item">
                <a href="{{url('student/my_account')}}" class="nav-link @if(Request::segment(2)=='account') active @endif">
                  <i class="nav-icon far fa-user"></i>
                  <p>
                    My account
                  </p>
