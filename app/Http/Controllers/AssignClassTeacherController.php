...
class AssignClassTeacherController extends Controller
{
    ...
    public function insert(Request $request)
    {
        if (!empty($request->teacher_id)) 
        {
            ...
            return redirect('admin/assign_class_teacher/list')->with('success', 'Assigned class to teacher successfully');
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect('admin/assign_class_teacher/list')->with('success', 'Assigned class to teacher successfully Updated');
    }

    public function edit_single($id, Request $request)
    {
        $getRecord = AssignClassTeacherModel::getSingle($id);
        if(!empty($getRecord))
        {
    ...
    public function delete($id)
    {
        $save = AssignClassTeacherModel::getSingle($id);
        $save->delete();
        return redirect()->back()->with('success', 'Assigned class to teacher successfully Deleted');
